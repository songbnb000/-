        ...
        <div class="singerdiv">
            ...
            <div class="singerdiv2">
                <div class="singerdiv2div1">
                    <h2 class="singerdiv2div1h2"><a href="http://127.0.0.1:8080/#/oumegril">欧美女歌手</a></h2>
...
export default {
    data(){
        return{
            list:["Doris Day","Mariah Carey","Dido","Madonna","Doris Day","Mariah Carey","Lady Gaga","Taylor Swift","Britney Spears","Alondra Bentley","Amy Sky","Kina Grannis","Barbara Mendes","Kathy Mattea","Adele","Elis Regina","Celine Dion","Jill Sobule","Katy Perry","Meditation Spa","Margot Reisinger","Ariana Grande","Shania Twain","Amy Diamond","Linda Jackson","Stella Starlight Trio","Lenka","Macy Gray","Dolores O'Riordan","Charlene Soraia","Daya","Ella Fitzgerald","Gloria Gaynor","Miley Cyrus","Sia","Jessie J","K.T. Oslin","Nicki Minaj","Terri Clark","Gretchen Wilson","Renee Rosnes","All About Maggie","Leddra Chapman","Mara","Eve St. Jones","Marie Fredriksson","Lori McKenna","Skeeter Davis","Robin Spielberg","Sussan Kameron"],
...
.singer{
    ...
    .singerdiv2div2div1{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeigril/1.jpg');
    ...
    .singerdiv2div2div2{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeigril/2.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div3{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeigril/3.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div4{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeigril/4.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
   .singerdiv2div2a{
