        ...
        <div class="singerdiv">
            ...
            <div class="singerdiv2">
                <div class="singerdiv2div1">
                    <h2 class="singerdiv2div1h2">全部歌手</h2>
                ...
                <div class="singerdiv2div2">
                    ...
                    <div class="singerdiv2div2div">
                       ...
                       <a href="javascript:;">
                        ...
                        <a href="javascript:;">
                            <div class="singerdiv2div2div5"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                许嵩
                            </a>
                        </a>
                       <a href="javascript:;">
                            <div class="singerdiv2div2div6"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                任贤齐
                            </a>
                        </a>
                        <a href="javascript:;">
                            <div class="singerdiv2div2div7"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                刘若英
                            </a>
                        </a>
                       <a href="javascript:;">
                            <div class="singerdiv2div2div8"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                梁静茹
                            </a>
                        </a>
                        <a href="javascript:;">
                            <div class="singerdiv2div2div9"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                林忆莲
                            </a>
                        </a>
                       <a href="javascript:;">
                            <div class="singerdiv2div2div10"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                李宗盛
                            </a>
                        </a>
...
.singer{
    ...
    .singerdiv2div2div1{
        width:180px;
        height:180px;
        background-image:url('./singer/1.jpg');
    ...
    .singerdiv2div2div2{
        width:180px;
        height:180px;
        background-image:url('./singer/2.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div3{
        width:180px;
        height:180px;
        background-image:url('./singer/3.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div4{
        width:180px;
        height:180px;
        background-image:url('./singer/4.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div5{
        width:180px;
        height:180px;
        background-image:url('./singer/5.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div6{
        width:180px;
        height:180px;
        background-image:url('./singer/6.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div7{
        width:180px;
        height:180px;
        background-image:url('./singer/7.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div8{
        width:180px;
        height:180px;
        background-image:url('./singer/8.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div9{
        width:180px;
        height:180px;
        background-image:url('./singer/9.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div10{
        width:180px;
        height:180px;
        background-image:url('./singer/10.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
   .singerdiv2div2a{
