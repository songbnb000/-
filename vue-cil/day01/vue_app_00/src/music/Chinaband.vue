        ...
        <div class="singerdiv">
            <div class="singerdiv1">
                <div class="singerdiv1div1">
                    <a href="javascript:;" class="singerdiv1diva">全部歌手</a>
                </div>
                <!--华语-->
                ...
                <div class="singerdiv1div3">
                    <ul>
                       <li>
                        ...
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">欧美男歌手</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">欧美女歌手</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">欧美乐队组合</a>    
                        </li>
                    </ul>
                </div>
                <!--日韩-->
            ...
            <div class="singerdiv2">
                <div class="singerdiv2div1">
                    <h2 class="singerdiv2div1h2"><a href="http://127.0.0.1:8080/#/Chinaband">华语乐队组合</a></h2>
...
export default {
    data(){
        return{
            list:["好妹妹","无印良品","沙漠五子D5","筷子兄弟","大庆小芳","小蓓蕾组合","宝宝巴士","传奇乐坊","南拳妈妈","五月天","咖啡因乐队","锦绣二重唱","草蜢","龙宽九段","南征北战NZBZ","玖壹壹","展展与罗罗","Beyond","女声四重唱","星月组合","夜猫组","风火海","飞石号","华夏民乐团","Awaken-F","19乐团","牛奶咖啡","SNH48","SNH48_BLUEV","鲍家街43号","兄弟本色","阿里郎","草原百灵合唱团","蛋糕炸弹","goldEN","ZOOM超能团","Hickey喜祺","清馨组合","八只眼","树屋女孩","N.P.E.自由引力","冉冉升起组合","山水组合","后海大鲨鱼乐队","WeWe","Ado","信乐团","脆乐团","非凡组合","乔紫乔"],
...
.singer{
    ...
    .singerdiv2div2div1{
        width:180px;
        height:180px;
        background-image:url('./singer/Chinaband/1.jpg');
    ...
    .singerdiv2div2div2{
        width:180px;
        height:180px;
        background-image:url('./singer/Chinaband/2.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    ...
    .singerdiv2div2div3{
        width:180px;
        height:180px;
        background-image:url('./singer/Chinaband/3.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    ...
    .singerdiv2div2div4{
        width:180px;
        height:180px;
        background-image:url('./singer/Chinaband/4.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    ...
    .singerdiv2div2div5{
        width:180px;
        height:180px;
        background-image:url('./singer/Chinaband/5.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
