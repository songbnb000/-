<template>
    <div class="singer">
        ...
        <div class="singerdiv">
            <div class="singerdiv1">
                <div class="singerdiv1div1">
                    <a href="http://127.0.0.1:8080/#/singer" class="singerdiv1diva">全部歌手</a>
                </div>
                <!--华语-->
                <div class="singerdiv1div2">
                    <ul>
                        <li>
                        ...
                        <li>
                            <a href="http://127.0.0.1:8080/#/Chinaband" class="singerdiv1div2a">华语乐队组合</a>
                        </li>
                        <li>
                            <a href="http://127.0.0.1:8080/#/musicoriginal" class="singerdiv1div2a">原创音乐人</a>
                        </li>
                    </ul>
                </div>
                <!--欧美-->
                <div class="singerdiv1div3">
                    <ul>
                       <li>
                           <a href="javascript:;" class="singerdiv1div21a">欧美</a>
                        </li>
                        <li>
                            <a href="http://127.0.0.1:8080/#/oumeiboy" class="singerdiv1div2a">欧美男歌手</a>
                        </li>
                        <li>
                            <a href="http://127.0.0.1:8080/#/oumeigril" class="singerdiv1div2a">欧美女歌手</a>
                        </li>
                        <li>
                            <a href="http://127.0.0.1:8080/#/oumeiitem" class="singerdiv1div2a">欧美乐队组合</a>    
                        </li>
                    </ul>
                </div>
                <!--日韩-->
                <div class="singerdiv1div4">
                    <ul>
                        <li>
                            <a href="javascript:;" class="singerdiv1div21a">日韩</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">韩国男歌手</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">韩国女歌手</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">韩国乐队组合</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">日本男歌手</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">日本女歌手</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="singerdiv1div2a">日本乐队组合</a>
                        </li>
                    </ul>
                </div>
                <!--其它歌手-->
                <div class="singerdiv1div5">
                    <a href="javascript:;" class="singerdiv1div5a">其它歌手</a>
                </div>
            </div>
            <!--z主体内容-->
            <div class="singerdiv2">
                <div class="singerdiv2div1">
                    <h2 class="singerdiv2div1h2"><a href="http://127.0.0.1:8080/#/oumeiboy">欧美男歌手</a></h2>
                    <div class="singerdiv2div1div">
                        <h3>索引:</h3>
                        <a href="">热门</a>
                        <a href="#A">A</a>
                        <a href="#B">B</a>
            ...
            <!--热门-->
                <div class="singerdiv2div2">
                    <h3 class="singerdiv2div2h3">
                        热门
                    </h3>
                    <div class="singerdiv2div2div">
                       ...
                       <a href="javascript:;">
                            <div class="singerdiv2div2div3"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                Jackson Turner
                            </a>
                        </a>
                        <a href="javascript:;">
                            <div class="singerdiv2div2div4"></div>
                            <a href="javascript:;" class="singerdiv2div2a">
                                R3hab
                            </a>
                        </a>
...
export default {
    data(){
        return{
            list:["Maksim","肖邦","CC","Vitas","Larry Adler","Kurmellow","Ron Goodwin","Michael Mayer","Dan Gibson's Solitudes","Le Fou","Martin Jacoby","Nat King Cole","Nadi","João Gilberto","Massage Tribe","Steven Halpern","Richard Clayderman","Vangelis","Jessita Reyes","Celso Fonseca","Dave Brubeck","Bert Kaempfert","Wiz Khalifa","Rick Kelly","Chris Malinchak","Horst Jankowski","Knox Summerour","Pianissimo Brothers","robert schumann","Antonio Carlos Jobim","Skip Peck","Christine Welch","Done Again","Studio Musicians","Gene Ammons","Oliver Nelson","Antonio Carlos Jobim","Red Garland","Jonas David","Bandari","Andrew Fitzgerald","SixFour","Jive Ass Sleepers","Allman Brown","Yoga Tribe","Sergei Rachmaninoff","Oscar Peterson","Vee Sing Zone","Leandro Lehart","G Pinto"],
            ...
            list2:[
                "贝多芬", "张韶涵", "曹轩宾", "夏雨菲", "新雅室内空气乐..", "谢安琪", "梦鸽", "大庆小芳", "齐秦", "小蓓蕾组合", "贾乃亮", "张可", "毛宁", "Percy Fait", "张穆庭", "罗大佑", "MC Hotdog",  "陈燕", "陈瑞","王筝", "何炅", "周笔畅", "王七七","张碧晨", "胡彦斌", "汪苏泷", "戚薇", "纯音乐", "王二妮", "大张伟", "纵贯线", "DJ小鱼儿", "杨钰莹","林凡","孙露", "费玉清", "孙盛希", "虎二","宝宝巴士","回音哥","陈奕迅","张婧","华晨宇","罗百吉","霍尊","张紫豪","温妮","G.E.M.邓紫棋","唐朝乐队","赵泳鑫"
            ],
            list3:[
...
.singer{
    ...
    .singerdiv2div2div1{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiboy/1.jpg');
    ...
    .singerdiv2div2div2{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiboy/2.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div3{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiboy/3.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div4{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiboy/4.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
   .singerdiv2div2a{
