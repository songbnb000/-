        ...
        <div class="singerdiv">
            ...
            <div class="singerdiv2">
                <div class="singerdiv2div1">
                    <h2 class="singerdiv2div1h2"><a href="http://127.0.0.1:8080/#/oumeiitem">欧美乐队组合</a></h2>
...
export default {
    data(){
        return{
            list:["February Four","Cosmic Gate","Westlife","Jono","Sweet Little Band","Backstreet Boys","Secret Garden","Folk Uke","Rockabye Baby!","L.A. Guns","McFly","Panama","Ashu","GOLDA","Spain","Schnappi","Mobb Deep","The Chainsmokers","Far East Movement","Simon & Garfunkel","Project X","The Black Eyed Peas","Fusion","DAMH","Boyzone","Fall Out Boy","Great White","The Little Singers","Instrumental","Mr. Big","Celtic Woman","The Jamborees","Kaoma","Lachi","Uriah Heep","The Blenders","Lithium","Kids United","Hardline","One Direction","Firehouse","Dreamtale","Mephisto Walz","Usha Uthup","Busted","Longfellow","Academy Allstars","Motorhead","Blake","Bossa Tres"],
...
.singer{
    ...
    .singerdiv2div2div1{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiitem/1.jpg');
    ...
    .singerdiv2div2div2{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiitem/2.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div3{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiitem/3.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
    .singerdiv2div2div4{
        width:180px;
        height:180px;
        background-image:url('./singer/oumeiitem/4.jpg');
        background-size:100% 100%;
        margin-bottom:10px;
    }
   .singerdiv2div2a{
